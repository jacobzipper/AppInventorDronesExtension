...
@DesignerComponent(version = YaVersion.LABEL_COMPONENT_VERSION,
        description = "A bunch of drone stuff",
        category = ComponentCategory.EXTERNAL,
        nonVisible = true,
        iconName = "images/externalComponent.png")
@SimpleObject
public final class AppInventorDrones extends AndroidNonvisibleComponent {
    
    public AppInventorDrones(ComponentContainer container) {
